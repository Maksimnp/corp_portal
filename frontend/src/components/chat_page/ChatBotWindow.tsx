...
const RenderChatBotWindow: React.FC<RenderChatBotWindowProps> = ({
    setHighlightMenu,
    highlightMenu,
    highlightMessages,
      ...
      <div className={`flex flex-col flex-1 transition-all duration-500 ease-out ${
        ...
        >
          <div 
            ...
            />
            {statusChatBot && (
              <div className={`flex justify-start group mb-[2px] relative size-fit px-3 py-1 ${theme === 'light' ? 'bg-gray-200' :'bg-slate-800 text-white'}  rounded-l-md rounded-r-2xl`}>
                <span>🧠 Думаю</span>
                <div className="flex space-x-1 items-end pb-1 pl-1">
...
export default RenderChatBotWindow;